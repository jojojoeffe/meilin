...
$config['sess_expire_on_close']	= FALSE; //Ganti TRUE kalo mau pake
$config['sess_encrypt_cookie']	= FALSE; //Ganti TRUE kalo mau pake
$config['sess_use_database']	= FALSE; //Ganti TRUE kalo mau pake
